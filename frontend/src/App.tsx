...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] text-oktawave-dark">
      <header className="bg-oktawave-blue text-white px-6 py-4 shadow-md">
        <h1 className="text-2xl font-bold tracking-tight">Aether Tax Portal</h1>
        <p className="text-sm opacity-85 mt-0.5">Financial Due-Diligence Intelligence Platform</p>
      </header>
